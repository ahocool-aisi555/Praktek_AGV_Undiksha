//AGV Web Remote Mode STA - Terhubung ke Router
...
IPAddress local_IP(192, 168, 0, 10); //IP dari wemos kamu, bedakan dengan punya teman
IPAddress gateway(192, 168, 0, 1);    // Sesuaikan dengan IP Router
...
void setup() {
  ...
  Serial.println("Memori WiFi telah dibersihkan!");
